                        ...
                        <div class="row">
                            <div class="col-md-6 col-md-push-3">
                                ...
                                <div class="bg-lightest border-1px p-30 mb-0">
                                    <h3 class="text-theme-colored mt-0 pt-5">Add pharmacies</h3>
                                    <hr>
                                    <p> </p>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input name="pharmacy_name" type="text" placeholder="Please enter pharmacy name" required="" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group">
...
{{--                                            <a href="06_add_doctor.html"><svg width="2em" height="2em" viewBox="0 0 16 16" class="bi bi-arrow-bar-left" fill="currentColor" xmlns="http://www.w3.org/2000/svg">--}}

                        ...
                        <div class="col-md-12">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered tbl-shopping-cart">
                                    ...
                                    <tr class="cart_item">
                                        <td class="product-remove"><a title="Remove this item" class="remove" href="javascript:void(0)" onclick="removeCartItem({{$item->temp_id}})">×</a></td>
...
{{--                                            </ul>--}}
                                        ...
                                        <td class="product-quantity"><div class="quantity buttons_added">
                                                <input type="hidden" name="cart_id[]" value="{{$item->temp_id}}">
                                        ...
                                        <td class="product-subtotal"><span class="amount">${{number_format(($item->qty*$item->price),2)}}</span></td>
                                    </tr>

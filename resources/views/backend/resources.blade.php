    ...
    <div class="col-sm-12">
        ...
        <div class="panel">
            <div class="panel-content">
                <div class="row">
                    <div class="col-md-12">
                        <form class="form-horizontal form-stripe" method="post" action="{{url('save-resources')}}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="link" class="form-control" required id="placeholder" placeholder=" Name">
                                </div>
                            </div>
                            <div class="form-group">

...
@section('content')
    ...
    <div class="col-sm-12">
        <h4 class="section-subtitle"><b>Update Services</b></h4>
        <div class="panel">
            <div class="panel-content">
                <div class="row">
                    <div class="col-md-12">
                        <form class="form-horizontal form-stripe" method="post" action="{{url('update-services')}}" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="service_id" value="{{$service->id}}">
                            <div class="form-group">
                                <label for="placeholder" class="col-sm-2 control-label"> Name</label>
                                <div class="col-sm-10">
                                    <input type="text" name="name" class="form-control" value="{{$service->name}}" required id="placeholder" placeholder=" Name">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="title" value="{{$service->title}}" required placeholder="Product Title" >
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="textarea" class="jqte-test">{{$service->description}}</textarea>
                                </div>
                            </div>

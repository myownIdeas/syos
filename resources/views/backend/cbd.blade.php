...
@section('content')
    ...
    <div class="col-sm-12">
        <h4 class="section-subtitle"><b>Add CBD</b></h4>
        <div class="panel">
            <div class="panel-content">
                <div class="row">
                    <div class="col-md-12">
                        <form class="form-horizontal form-stripe" method="post" action="{{url('save-cbd')}}" enctype="multipart/form-data">
                            @csrf

                            <div class="form-group">
                                <label for="placeholder" class="col-sm-2 control-label"> Name</label>
                                <div class="col-sm-10">
                                    <input type="text" name="name" class="form-control" required id="placeholder" placeholder=" Name">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label for="readonly" class="col-sm-2 control-label">CBD INFO</label>
                                <div class="col-sm-10">

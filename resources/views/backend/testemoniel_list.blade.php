                    ...
                    <table id="basic-table " class="data-table table status_check table-striped nowrap table-hover" cellspacing="0" width="100%">
                        ...
                        @foreach($lists as $list)
                            <tr>
                                ...
                                <td><img src="{{asset('/images').'/'.unserialize($list->image)[0]}}" width="30px" height="30px" /></td>


                                <td>
                                    <a href="{{url('show-testemonial-update-page/'.$list->id)}}" class="btn btn-success">Update</a>
                                <a href="{{url('deleteItems/?id='.$list->id.'&table=testimonial&red=list-testimonial')}}" onclick="return confirm('Are you sure you want to delete this item?');" class="btn btn-success">Delete</a></td>
